...
config = {
    ...
    "encoder_lora_layer": [],
    "out_dir": "/home/mdjaberal.nahian/lightning-sam/lightning_sam/Error_OUT/Out_H_100_Decoder_error_55",
    "opt": {
        "learning_rate": 1e-7,
        "weight_decay": 1e-5,
        "decay_factor": 0.1,
    ...
    "dataset": {
        "train": {
            ...
            "annotation_file": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/trian_modified_annotations/dataset_errors_55_error_prob_0.6_shift_20_scale_20_overlap_0.1.json"
        },
        "val": {
            "root_dir": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/valid",
            "annotation_file": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/valid_modified_annotations/dataset_errors_55_error_prob_0.6_shift_20_scale_20_overlap_0.1.json"
        },
         'bbox': {
