...
config = {
    ...
    "encoder_lora_layer": [],
    "out_dir": "/home/mdjaberal.nahian/lightning-sam/lightning_sam/Out_H_50_Error_30_Dec",
    "opt": {
        "learning_rate": 1e-7,
        "weight_decay": 1e-5,
        "decay_factor": 0.1,
    ...
    "model": {
        ...
        "checkpoint": "/home/mdjaberal.nahian/lightning-sam/lightning_sam/Out_H_50/best_epoch.pth",
        "freeze": {
            "image_encoder": True,
            "prompt_encoder": True,
            "mask_decoder": False,
    ...
    "dataset": {
        "train": {
            ...
            "annotation_file": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/train_new_annotations_with_errors.json"
        },
        "val": {
            "root_dir": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/valid",
            "annotation_file": "/home/mdjaberal.nahian/wheat_segmentation.v2i.coco-segmentation/valid_new_annotations_with_errors.json"
        },
         'bbox': {
