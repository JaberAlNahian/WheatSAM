...
def load_datasets(cfg, img_size):
    ...
    val = COCODataset(root_dir=cfg.dataset.val.root_dir,
                      ...
                      transform=transform)
    test = TestDataset(root_dir=cfg.dataset.test.root_dir, transform=transform)  # Add loading of test dataset
    ...
    test_dataloader = DataLoader(test,
                                  batch_size=cfg.batch_size,
                                  shuffle=False,
                                  num_workers=cfg.num_workers)  # No need for collate_fn for test dataset
