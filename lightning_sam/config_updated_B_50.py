...
config = {
    ...
    "encoder_lora_layer": [],
    "out_dir": "/home/mdjaberal.nahian/lightning-sam/lightning_sam/Out_B_100_error_20",
    "opt": {
        "learning_rate": 1e-7,
        "weight_decay": 1e-5,
        "decay_factor": 0.1,
    ...
    "model": {
        "type": 'vit_b',
        "checkpoint": "/home/mdjaberal.nahian/lightning-sam/lightning_sam/Out_B_100/best_epoch.pth",
